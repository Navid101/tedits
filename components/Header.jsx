  ...
  return (
        <div className='flex flex-col space-y-6 xl:space-y-0 '>
            <div className='h-12 w-12 xl:hidden block '>
                <Image src="https://media.discordapp.net/attachments/235680551363674112/997039578043121674/000116154244_326803261677684_2838756276716891239_n.png?width=592&height=676" width="447px" height="521px" layout='responsive' alt='Logo' className='object-cover'></Image>
            </div>
